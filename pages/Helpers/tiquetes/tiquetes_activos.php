...
<body>
    ...
    <div class="center-table">
        <div class="container-table mt-10" style="width:95%">
            <table id="tabla-tiquetes_activos" class="display" style="width:100%">
            <center><h3>INCIDENTES / PROBLEMAS ACTIVOS</h3></center>
                <thead>
                    <tr>
                        <th></th>
                        <th>TIQUETE</th>
                        <th>ESTADO</th>
                        <th>ELEMENTO_PRINCIPAL</th>
                        <th>HOST_NAME</th>
                        <th>FECHA_HORA_INICIO</th>
                        <th>ULTIMA_MODIFICACION</th>
                        <th>DESCRIPCION</th>
                        <th>GRUPO_ANALISTA</th>
                        <th>TIPO</th>
                    </tr>
                </thead>
            </table>
    ...
    <script src="../../../script/helpers/tiquetes_activos.js"></script>
</body>
