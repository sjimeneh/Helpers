...
<body>
    ...
    <div id="tab1" class="tab active">
        <form id="form_consulta_etp" class="p-5 shadow-4 d-flex justify-content-center w-sm-full btn-square">
            <label for="input_consulta_etp_nodo" class="me-md-2">NODO</label>
            <div class="form-group row w-64">
                <div class="col input-group input-group-sm input-group-inline shadow-none">
                    ...
                    <input type="text" id="input_consulta_etp_nodo_mac" name="input_consulta_etp_nodo_mac" class="form-control" placeholder="Buscar MACS">
                </div>
            </div>
        </form>
        <div class="center-table">
            <div class="content-table mt-10" style="width:95%">
                <table id="tabla-nodos-etp" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <!-- <th></th> -->
                            <th>Servicio Id</th>
                ...
                <button id="export-table-node-etp" class="btn btn-primary">
                    <span class="pe-2">
    ...
    <script type="module" src="../../../script/helpers/Etp.js"></script>
